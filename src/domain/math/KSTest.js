...
exports.calculateKSTest = calculateKSTest;
/**
 ...
 * - Variance = ((b - a + 1)² - 1) / 12
 */
function calculateTheoretical(poolConfig, count) {
 ...
 */
function calculateKSTest(draws, config) {
    ...
    const threshold = 0.2;
    const classification = dStatistic <= threshold ? 'Random' : 'Patterned';
    return {
        dStatistic,
        empiricalMean,
        empiricalStdDev,
