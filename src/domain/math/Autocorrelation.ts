 ...
 */
export function calculateLag1Autocorrelation(draws: Draw[]): AutocorrelationResult {
  ...
  const interpretation: 'Independent' | 'Dependent' = isSignificant ? 'Dependent' : 'Independent'
