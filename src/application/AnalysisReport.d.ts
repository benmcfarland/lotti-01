 ...
 */
export declare function determineStatus(pValue: number, isSignificant: boolean): TestStatus;
/**
 ...
 */
export declare function aggregateStatus(statuses: TestStatus[]): TestStatus;
