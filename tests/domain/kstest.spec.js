...
;(0, vitest_1.describe)('Kolmogorov-Smirnov Test for Draw Sums', () => {
  ...
  ;(0, vitest_1.it)(
    'calculates empirical mean close to theoretical mean for uniform distribution',
    () => {
      const result = (0, KSTest_1.calculateKSTest)(syntheticDraws, gameConfig)
      ...
      ;(0, vitest_1.expect)(Math.abs(result.empiricalMean - result.theoreticalMean)).toBeLessThan(
        10
      )
    }
  )
  ...
  ;(0, vitest_1.it)('theoretical values match manual calculation', () => {
    ...
    ;(0, vitest_1.expect)(Math.abs(result.theoreticalStdDev ** 2 - expectedVariance)).toBeLessThan(
      1
    )
  })
