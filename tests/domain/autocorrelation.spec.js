...
;(0, vitest_1.describe)('Lag-1 Autocorrelation Test for Draw Independence', () => {
  ...
  ;(0, vitest_1.it)('throws on insufficient draws', () => {
    ...
    ;(0, vitest_1.expect)(() =>
      (0, Autocorrelation_1.calculateLag1Autocorrelation)(shortDraws)
    ).toThrow()
  })
  ...
  ;(0, vitest_1.it)(
    'supports Skeptical Realist persona - proves independence on uniform data',
    () => {
      const result = (0, Autocorrelation_1.calculateLag1Autocorrelation)(syntheticDraws)
  ...
  ;(0, vitest_1.it)('distinguishes between zero and non-zero correlation', () => {
    ...
    ;(0, vitest_1.expect)(ascendingResult.lag1Correlation).toBeGreaterThan(
      randomResult.lag1Correlation + 0.5
    )
  })
})
