...
;(0, vitest_1.describe)('AnalyzeGame Application Service', () => {
  ...
  ;(0, vitest_1.it)('aggregates statuses correctly', () => {
    ;(0, vitest_1.expect)((0, AnalysisReport_1.aggregateStatus)(['PASS', 'PASS', 'PASS'])).toBe(
      'PASS'
    )
    ;(0, vitest_1.expect)((0, AnalysisReport_1.aggregateStatus)(['PASS', 'WARN', 'PASS'])).toBe(
      'WARN'
    )
    ;(0, vitest_1.expect)((0, AnalysisReport_1.aggregateStatus)(['FAIL', 'PASS', 'PASS'])).toBe(
      'FAIL'
    )
    ;(0, vitest_1.expect)((0, AnalysisReport_1.aggregateStatus)(['WARN', 'FAIL', 'PASS'])).toBe(
      'FAIL'
    )
  })
  ;(0, vitest_1.it)('includes interpretation for each test', async () => {
    ...
    ;(0, vitest_1.expect)(['Independent', 'Dependent']).toContain(
      report.autocorrelationTest.interpretation
    )
  })
