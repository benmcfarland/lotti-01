...
;(0, vitest_1.describe)('SimulateStrategy - Dual Track Simulation', () => {
  ...
  ;(0, vitest_1.describe)('Divergence Calculation', () => {
    ...
    ;(0, vitest_1.it)(
      'shows small divergence when strategy performs like random (convergence)',
      async () => {
  ...
  ;(0, vitest_1.describe)('Match Counting', () => {
    ...
    ;(0, vitest_1.it)('with bonus pool, counts matches including bonus', async () => {
      ...
      const simulateWithBonus = new SimulateStrategy_1.SimulateStrategy(
        strategyWithBonus,
        rng,
        configWithBonus
      )
  ...
  ;(0, vitest_1.describe)('Conclusion Generation', () => {
    ...
    ;(0, vitest_1.it)(
      'distinguishes between strategy outperformance and underperformance',
      async () => {
        const targetNumbers = [1, 2, 3, 4, 5]
  ...
  ;(0, vitest_1.describe)('Expected Matches Calculation', () => {
    ;(0, vitest_1.it)(
      'calculates expected matches based on combinatorial probability',
      async () => {
        const targetNumbers = [1, 2, 3, 4, 5]
        ...
        ;(0, vitest_1.expect)(report.randomTrack.expectedMatches).toBe(
          report.strategyTrack.expectedMatches
        )
      }
    )
    ;(0, vitest_1.it)('both tracks have same expected matches (baseline agnostic)', async () => {
      ...
      const report = await simulateStrategy.execute('test-sim', targetNumbers, undefined, 500)
      ;(0, vitest_1.expect)(report.strategyTrack.expectedMatches).toBe(
        report.randomTrack.expectedMatches
      )
    })
  })
